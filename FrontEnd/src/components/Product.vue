    ...
    <v-container>
      <div class="row">
        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            <p class="display-1 mb-0">Katana</p>
            <v-card-actions class="pa-0">
              <p class="headline font-weight-light pt-3">300.00 €</p>
              <v-spacer></v-spacer>
              <v-rating v-model="rating" class="" background-color="warning lighten-3"
                        color="warning" dense></v-rating>
              <span class="body-2	font-weight-thin"> 25 Avis</span>
            </v-card-actions>
            <p class="subtitle-1 font-weight-thin">
              Katana des grands samourai de wano
            </p>
            ...
            <v-text-field
                ...
                dense
            ></v-text-field>
            <v-btn class="primary white--text" outlined tile dense><v-icon>mdi-cart</v-icon> Ajouter au panier</v-btn>
      ...
      <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12">
          <v-tabs>
            ...
            <v-tab >Description Technique</v-tab>
            <v-tab>Avis</v-tab>
            <v-tab-item>
          ...
          <v-card-text
            ...
            outlined
          >
            <p class="subtitle-1 font-weight-light pt-3 text-center">Ces articles peuvent vous intéresser aussi</p>
            <v-divider></v-divider>
                ...
                >
                  ...
                  >
                    <v-img
                      class="white--text align-end"
                      height="200px"
                      :src="require('../assets/img/shop/katana.jpg')"
                    >
                    </v-img>
        ...
        <v-row no-gutters>
          <v-col class="col-12 col-md-4 col-sm-12">
            <v-row >
              ...
              <v-col class="col-12 col-sm-9 pr-4">
                <h3 class="font-weight-light">LIVRAISON & RETOUR GRATUIT</h3>
          ...
          <v-col class="col-12 col-md-4 col-sm-12">
            <v-row >
              ...
              <v-col  class="col-12 col-sm-9 pr-4">
                <h3 class="font-weight-light">REMBOURSER A 100%</h3>
                <p class="font-weight-thin">Garantie de remboursement en 30 jours maximum</p>
              </v-col>
            </v-row>
          </v-col>
          <v-col class="col-12 col-md-4 col-sm-12">
            <v-row>
              ...
              <v-col  class="col-12 col-sm-9 pr-4">
                <h3 class="font-weight-light">07 69 03 59 05</h3>
                <p class="font-weight-thin">Support disponible 24/7</p>
              </v-col>
            </v-row>
          </v-col>
        </v-row>
